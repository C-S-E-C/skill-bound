...
function applyTranslations() {
  ...
  if (localStorage.getItem("dev") == "true") {
    json = JSON.parse(localStorage.getItem("translation")) || {};
  }
  elements.forEach(el => {
...
function Observer() {
  ...
  setInterval(() => {applyTranslations();}, 500);
}